...
import LawWorkflow from './components/LawWorkflow';
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<'feed' | 'saved' | 'profile' | 'map' | 'digest' | 'analytics' | 'community' | 'simulation' | 'workflow' | 'bill_simulator' | 'protest_guide'>('feed');
