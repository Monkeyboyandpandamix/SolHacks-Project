...
const COLORS = ['#4f46e5', '#059669', '#ea580c', '#e11d48', '#0ea5e9', '#a855f7'];
    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          { label: 'Trend Velocity', value: `${averageVelocity}`, icon: <TrendingUp size={24} />, color: 'text-rose-600', bg: 'bg-rose-50' },
        ].map((stat, idx) => (
          <motion.div
            key={idx}
          ...
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={categoryData}>
                ...
                <Tooltip cursor={{ fill: '#f8fafc' }} contentStyle={{ borderRadius: '16px', border: 'none', boxShadow: '0 10px 15px -3px rgb(0 0 0 / 0.1)', fontWeight: 900 }} />
          ...
          <div className="flex h-[300px] items-center justify-center">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Legend verticalAlign="bottom" height={36} formatter={(value) => <span className="text-xs font-black uppercase tracking-widest text-slate-500">{value}</span>} />
              </PieChart>
            </ResponsiveContainer>
          </div>
        </div>
              ...
              <div key={item.region}>
                ...
                <div className="h-4 rounded-full bg-slate-100">
                  <div
                    ...
                    style={{
                      width: `${Math.min(100, Math.max(10, Math.abs(item.sentiment) + 20))}%`,
