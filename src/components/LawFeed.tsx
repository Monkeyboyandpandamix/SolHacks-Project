...
const LawFeed: React.FC<LawFeedProps> = ({ laws, allLaws = laws, isLoading, error, onSave, onVote, onComment, onPollVote, onAddImpactStory, onSaveToCollection, collections = [], onCompare, comparingIds = [], onToggleFollowTopic, followedTopics = [] }) => {
  ...
  return (
    <div className="w-full">
      <div className="mb-6 flex items-center justify-between">
        ...
        <span className="text-sm font-medium text-muted">{laws.length} laws found</span>
      </div>
      <motion.div 
