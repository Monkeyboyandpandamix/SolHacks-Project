...
const LocationSelector: React.FC<LocationSelectorProps> = ({ onLocationChange, onInterestChange, initialState, initialCity, initialLanguage, initialInterest = 'all' }) => {
  ...
  const interests = [
    ...
    { id: 'language_rights', label: 'Language Rights' },
    { id: 'indigenous_rights', label: 'Indigenous Rights' },
    { id: 'arts_culture', label: 'Arts & Culture Funding' },
    { id: 'racial_equity', label: 'Racial Equity' },
    { id: 'religious_freedom', label: 'Religious Freedom' },
    { id: 'lgbtq_rights', label: 'LGBTQ+ Rights' },
    { id: 'refugee', label: 'Refugee' },
    { id: 'voting_access', label: 'Voting Access' },
